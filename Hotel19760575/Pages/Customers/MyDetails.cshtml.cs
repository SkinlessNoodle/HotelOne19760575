...
namespace Hotel19760575.Pages.Customers
{
    ...
    public class MyDetailsModel : PageModel
    {
        ...
        public MyDetailsModel(Hotel19760575.Data.ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (customer != null)
            {
                ...
                {
                    // Retrieve customer details for display in the web form
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            // Construct this customer object based on values assigned to 'Myself'
